package kr.hhplus.be.server.api.service.concert.presentation;
...
import kr.hhplus.be.server.api.service.concert.presentation.dto.ConcertScheduleResponse;
import kr.hhplus.be.server.api.service.concert.presentation.dto.ConcertSeatResponse;
...
public class ConcertController {
	...
	public ResponseEntity<ApiResult<ConcertScheduleResponse>> getAvailableDates(
		...
		return ResponseEntity.ok(ApiResult.of("예약 가능한 날짜가 조회되었습니다.", response));
	}
	...
	public ResponseEntity<ApiResult<ConcertSeatResponse>> getAvailableSeats(
		...
		return ResponseEntity.ok(ApiResult.of("예약 가능한 좌석이 조회되었습니다.", response));
	}
}